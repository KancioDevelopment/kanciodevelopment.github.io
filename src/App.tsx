...
function App() {
  React.useEffect(() => {
    // Only bind mousemove if device actually supports fine hover (desktop / trackpad)
    // Low-end mobile touch devices have no hover; running querySelectorAll + getBoundingClientRect causes severe layout thrashing!
